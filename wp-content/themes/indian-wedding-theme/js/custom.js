jQuery(document).ready(function($) {
    ...
    // Initialize animations for event cards when they come into view
    function initEventCardAnimations() {
        $('.event-card').each(function(index) {
            var $card = $(this);
            var delay = $card.data('animate-delay') || (index * 0.1) + 's';
    ...
    // Initialize animations for ritual items when they come into view
    function initRitualAnimations() {
        $('.ritual-item').each(function(index) {
            var $item = $(this);
    ...
    // Initialize ritual animations
    initRitualAnimations();
    
    // Initialize animations for gallery items when they come into view
    function initGalleryAnimations() {
        $('.gallery-item').each(function(index) {
            var $item = $(this);
            var delay = $item.data('animate-delay') || (index * 0.1) + 's';
    ...
    $('.tab-btn').on('click', function() {
        ...
        // Show corresponding content with fade in after a small delay
        setTimeout(function() {
