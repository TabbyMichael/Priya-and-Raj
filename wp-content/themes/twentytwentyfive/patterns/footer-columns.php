			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group" style="padding-right:0;padding-left:0">
					...
					<!-- wp:navigation {"overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"fontSize":"medium","layout":{"type":"flex","orientation":"vertical"},"ariaLabel":"<?php esc_attr_e( 'Stories', 'twentytwentyfive' ); ?>"} -->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Events', 'twentytwentyfive' ); ?>","url":"#events"} /-->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Venue', 'twentytwentyfive' ); ?>","url":"#venue"} /-->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Rituals', 'twentytwentyfive' ); ?>","url":"#rituals"} /-->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Gallery', 'twentytwentyfive' ); ?>","url":"#gallery"} /-->
					<!-- /wp:navigation -->
				</div>
				<!-- /wp:group -->
				<!-- wp:group {"style":{"spacing":{"padding":{"right":"0","left":"0"}}},"layout":{"type":"constrained"}} -->
				<div class="wp-block-group" style="padding-right:0;padding-left:0">
					...
					<!-- wp:navigation {"overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"fontSize":"medium","layout":{"type":"flex","orientation":"vertical"},"ariaLabel":"<?php esc_attr_e( 'Featured', 'twentytwentyfive' ); ?>"} -->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Dietary', 'twentytwentyfive' ); ?>","url":"#dietary"} /-->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Livestream', 'twentytwentyfive' ); ?>","url":"#livestream"} /-->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'FAQ', 'twentytwentyfive' ); ?>","url":"#faq"} /-->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Contact', 'twentytwentyfive' ); ?>","url":"#contact"} /-->
					<!-- /wp:navigation -->
				</div>
				<!-- /wp:group -->
			</div>
